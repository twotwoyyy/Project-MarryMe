            ...
            <form method="post" action="../adminpage/adminpage_qna_insert_ok.do">
                <table class="notice-form-table">
                    <tr id="white">
                        <th width="20%">번호</th>
                        <td width="30%">
                            <div class="notice-form-readonly">QnA의 qna_no ${vo.msg}</div>
                        </td>
                        <th class="custom-height" width="20%">구분</th> <!-- 수정된 부분 -->
					    <td width="30%">
					        <div class="notice-form-readonly">QnA의 cate ${vo.cate }</div>
					    </td>
                    </tr>
                    <tr id="white">
                        <th width="20%">아이디</th>
                        <td width="30%">
                            <div class="notice-form-readonly">QnA의 id ${vo.id }</div>
                        </td>
                        <th class="custom-height" width="20%">날짜</th> <!-- 수정된 부분 -->
					    <td width="30%">
					        <div class="notice-form-readonly">QnA의 날짜 "${vo.dbday }"</div>
					    </td>
                    </tr>
                    <tr id="white">
                        <th width="20%">문의 내용</th>
                        <td width="80%" colspan="3">
                            <div class="notice-form-readonly notice-form-readonly-large">QnA의 msg ${vo.msg }</div>
                        </td>
                    </tr>
                    <tr>
