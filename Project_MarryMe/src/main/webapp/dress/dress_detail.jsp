                        ...
                        <div id="brand">
						    ...
						    <div id="image">
						        <div class="masonry_wrap">
						            <!-- 첫 번째 이미지 -->
						            <div class="img_wrap">
						                <img src="${dress_vo.d_detail_image}" alt="" style="width: 100%; height: auto;">
						            </div>
						            
						            <!-- 세 번째 이미지 -->
						            <div class="img_wrap">
						                <img src="${dress_vo.d_detail_image3}" alt="" style="width: 100%; height: auto;">
						            </div>
						            
						            <div class="content_description">
								        <p>${dress_vo.d_content}</p> <!-- d_content를 <p> 태그로 감싸서 내용 출력 -->
								    </div>
						        </div>
						    </div>
						</div>
                        ...
                        <div id="return_exchange">
						    ...
						    <table>
						        <tr>
						            ...
						            <td>
						                <p>본 제품은 1:1 주문제작(선주문 후 제작) 상품으로 주문 취소 및 환불, 교환이 불가능하니 신중한 구매 부탁드립니다.</p>
						                
						                <p>고객센터와 제품 확인 후 제품 불량으로 판명되어 교환이 불가피할 경우, 같은 상품으로 재제작해 드립니다.</p>
						                <p><strong>빠른 해결을 위해 상품 하자 발견 즉시 고객센터로 연락 부탁드립니다.</strong></p>
						                
						                <p>사전 협의 없이 상품을 보내시는 경우에는 수취 거부되오니, 반드시 게시판 접수 및 고객센터 연락 후 보내주시기 바랍니다.</p>
						                <p>상품을 공급 받으신 날로부터 7일 이내 접수해 주셔야 합니다.</p>
						                
						                <p>당사 택배를 이용하여 주셔야 하며, 타 택배 이용 시 선불로 지불하신 후 보내주셔야 합니다.</p>
						                
						                <h4>대여 취소 정책</h4>
						                <ul>
						                    <li>한 달 전 취소 - 100% 환불</li>
						                    <li>3주 전 취소 - 80% 환불</li>
						                    <li>2주 전 취소 - 50% 환불</li>
						                    <li>1주 전 취소 - 20% 환불</li>
						                    <li>6일 이후 환불 불가</li>
						                ...
						                <p><strong>대여 상품은 출고 후 어떠한 경우에도 취소/교환/환불이 불가합니다.</strong></p>
						                <p>소모품은 분실 시 유상 구입을 원칙으로 합니다.</p>
						                <p>제품이 고객의 부주의로 훼손될 경우 정도에 따라 비용이 부과될 수 있습니다.</p>
						                <p>교환 및 반품 택배비는 고객님 부담입니다.</p>
						                
						                <h4>화이트 원단 및 기타 주의 사항</h4>
						                <ul>
						                    <li>화이트 원단 특성상(더블 구입, 단순 변심) 교환, 반품, 환불이 불가하니 신중한 선택과 충분한 상담 후 구입해 주세요.</li>
						                    <li>냄새(향수), 구김이 심한 경우, 기타 오염, 판매 상품으로 가치가 상실된 경우 교환 및 반품이 불가합니다.</li>
						                    <li>인수 후에는 제품 하자나 오배송의 경우를 제외한 고객님의 단순 변심에 의한 교환, 반품이 불가능할 수 있습니다.</li>
						                    <li>보낸 상태(포장, 택) 유지되어 있어야 교환 및 반품이 가능합니다.</li>
						                </ul>
						
						                <h4>불량 사유 관련 안내</h4>
						                <p>아래 내용은 불량 사유가 아닙니다:</p>
						                <ul>
						                    <li>개인적인 견해는 불량 사유가 아닙니다. (예: 원단이 뻣뻣하다 / 너무 부드럽다 / 덜 반짝인다 등)</li>
						                    <li>상품 택 불량 / 배송 중 상품의 구김, 펄 비즈 떨어짐 / 제작 중 발생한 실밥, 올풀림, 답사 / 세탁 후 지워지는 가벼운 얼룩, 초크 자국 / 경미한 바느질 미흡 등은 불량의 사유가 아닙니다.</li>
						                    <li>측정 위치나 원단, 디자인에 따라 약간의 오차는 발생될 수 있습니다. 2~3cm 정도의 오차 범위는 불량의 사유가 아닙니다.</li>
						                    <li>화이트와 같은 밝은 색상의 상품은 원단 생산 과정에서 발생되는 미세한 이염이나 잡사가 있을 수 있습니다.</li>
						                </ul>
						
						                <p>이용 전 주의 사항 및 약관 사항을 읽지 않아 생기는 불이익에 대해서 본사의 책임이 없음을 알려드립니다.</p>
						            </td>
						        </tr>
						    </table>
						</div>
